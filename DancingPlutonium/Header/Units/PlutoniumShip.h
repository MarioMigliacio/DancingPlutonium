...
namespace DancingPlutonium
{
	...
	public:
		...
		void AddBomb();
		/* Returns whether or not this unit is currently shooting a bomb. */
		bool IsShootingBomb();
		/* Changes the state of isShootingBomb for this PlutoniumShip object. */
		void ToggleShootingBomb();
		/* Returns whether or not this unit can shoot a bomb. */
		bool CanUseBomb();
		/* Call upon this unit to shoot a bomb. */
		Bomb* GetBomb();
	...
	private:
		...
		bool isShootingBomb;								/* Represents the isShootingBomb state for this PlutoniumShip object. */
